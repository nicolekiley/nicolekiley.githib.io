...
app.get('/vw_memberblogs/?', function (req, res) {
   console.log("Route /vw_memberblogs GET", req.params);
   let data = [];
   let sql = "SELECT * FROM vw_memberblogs";
   ...
   connection.query(sql, data,
      function (errQuery, rows) {
         if (errQuery) {
            ...
            console.log("No memberblog rows...\n");
            res.json({rows: [], err: ""});
         }
      }
   );
